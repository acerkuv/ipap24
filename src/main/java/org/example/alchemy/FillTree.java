...
//                if(str.equals(currentNode.getValue())) {   // если такой элемент в дереве уже есть, не сохраняем его
...
//                            return;    // просто выходим из метода
//                        }
//                        else  if (!value.equals(currentNode.getValue())) {   // движение влево?
//                            currentNode = currentNode.getLeftChild();
